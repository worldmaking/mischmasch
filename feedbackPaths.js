...
// }
    ...
    let parents = Object.keys(localGraph.nodes)
            ...
            if(adjacents[nodeParent].length===0){
                ...
                for(i=0;i<adjacents[nodeParent].length;i++){
                    ...
                    if (nodes.includes(adjacentParent) === false) {
                        ...
                        let flag = visitUtil(adjacentParent, adjacentIndex)
    ...
    function visitUtil(name, index, arc){
        ...
        for(i=0;i<adjacents[name].length;i++){
            ...
            if (nodes.includes(adjacentParent) === false || adjacents[name].length===0 || adjacents[adjacentParent].length ===0) {
                ...
                flag = visitUtil(adjacentParent, adjacentIndex, adjacentArc)
                if(flag == true){
                    return true
                }
            // //     }
...
module.exports = {
    // getFeedbackPaths: getFeedbackPaths,
}
