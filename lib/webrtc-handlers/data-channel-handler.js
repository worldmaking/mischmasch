...
function dataChannelHandler(ourPeerId, ourPeerType, peer, syncStates, docId) {
    const peerId = peer.peerId;

    // add peer to syncStates
    console.log(ourPeerId, ourPeerType, peer, syncStates, docId)
    // syncStates[peerId] = { }
    ...
    const onOpen = (event) => {
        ...
        */
        ...
        // create document sync state for this peer connection
