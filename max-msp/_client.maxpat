...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 18.0, 1121.0, 917.0, 416.0 ],
					"proportion" : 0.5
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 861.0, 805.0, 50.0, 22.0 ],
					"text" : "initiate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -8.5, 88.0, 54.0, 22.0 ],
					"text" : "deferlow"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ -8.5, 64.0, 22.0, 22.0 ],
					"text" : "t b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -8.5, 34.0, 84.0, 22.0 ],
					"text" : "clear, compile"
				}
...
,
					"patching_rect" : [ 11.0, 999.0, 89.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "dictionary", "", "", "" ],
					"patching_rect" : [ 11.0, 1027.0, 60.0, 22.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0,
						"parameter_enable" : 0,
						"parameter_mappable" : 0
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -8.5, 116.5, 75.0, 50.0 ],
					"presentation" : 1,
...
,
					"patching_rect" : [ 87.0, 63.0, 47.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 87.0, 34.0, 112.0, 22.2545166015625 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1015.0, 42.0, 115.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1015.0, 91.0, 69.0, 22.0 ],
					"text" : "clearScene"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1015.0, 64.0, 100.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 462.0, 17.0, 119.0, 34.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					"id" : "obj-14",
					"items" : [ "example.json", ",", "First_Test_Session.json", ",", "forTesting.json", ",", "session_1555103217536.json", ",", "session_1555358410128.json", ",", "session_1555358432443.json", ",", "session_1555358577456.json", ",", "test2.json", ",", "test3.json" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"midpoints" : [ 1024.5, 177.5, 244.5, 177.5 ],
					"source" : [ "obj-116", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"midpoints" : [ 1.0, 177.25, 244.5, 177.25 ],
					"order" : 0,
					"source" : [ "obj-13", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"midpoints" : [ 96.5, 176.0, 244.5, 176.0 ],
					"source" : [ "obj-143", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 666.500012207031205, 505.0, 1004.600006103515625, 505.0, 1004.600006103515625, 52.0, 670.5, 52.0 ],
					"source" : [ "obj-26", 6 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 455.600012207031227, 533.0, 215.5, 533.0, 215.5, 52.0, 318.0, 52.0 ],
					"source" : [ "obj-26", 3 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-14", 0 ],
					"midpoints" : [ 385.300012207031273, 531.0, 215.75, 531.0, 215.75, 52.0, 318.0, 52.0 ],
					"order" : 1,
					"source" : [ "obj-26", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"midpoints" : [ 117.5, 176.5, 244.5, 176.5 ],
					"source" : [ "obj-38", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-81", 0 ],
					"midpoints" : [ 1.0, 941.75, 244.5, 941.75 ],
					"order" : 0,
					"source" : [ "obj-87", 0 ]
				}
...
, 			{
				"boxes" : [ "obj-38", "obj-143", "obj-13", "obj-140", "obj-87", "obj-101", "obj-92" ]
			}
, 			{
