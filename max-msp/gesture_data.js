...
function client (msg){
	...
	outlet(0, 'id', id, 'position', data.head.pos.x, data.head.pos.y, data.head.pos.z)
	outlet(1, 'id', id, 'quat', data.head.orient._x, data.head.orient._y, data.head.orient._z, data.head.orient._w)
