...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 674.0, 225.0, 142.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 674.0, 192.0, 106.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"lockeddragscroll" : 0,
					"maxclass" : "bpatcher",
					"name" : "freevoib.maxpat",
					"numinlets" : 1,
					"numoutlets" : 1,
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1118.0, 125.0, 113.0, 263.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 604.25, 392.0, 100.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "signal", "signal", "signal" ],
					"patching_rect" : [ 357.0, 159.0, 55.0, 22.0 ],
					"text" : "gen~ ffm"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 826.75, 521.0, 112.0, 177.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal", "signal", "signal" ],
					"patching_rect" : [ 856.75, 358.0, 145.0, 133.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal", "signal", "signal" ],
					"patching_rect" : [ 379.5, 281.0, 145.0, 133.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal", "signal", "signal" ],
					"patching_rect" : [ 362.5, 475.0, 259.5, 312.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 127.0, 776.0, 54.0, 22.0 ],
					"text" : "onecopy"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1118.0, 94.0, 122.0, 23.0 ],
					"text" : "gen~ freevoib.gendsp"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "signal", "signal", "signal" ],
					"patching_rect" : [ 357.0, 124.0, 94.0, 22.0 ],
					"text" : "gen~ lfo.gendsp",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 812.0, 907.0, 40.25, 22.0 ],
					"text" : "dac~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 357.0, 91.0, 110.0, 22.0 ],
					"text" : "gen~ noise.gendsp"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 91.0, 52.0, 150.0, 22.0 ],
					"text" : "gen~ complexLFO.gendsp"
				}
