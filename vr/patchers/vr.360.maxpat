...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 15.0, 35.0, 334.0, 20.0 ],
					"style" : "",
					"text" : "An example of displaying a 360 image (or movie) in the HMD"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 592.0, 169.0, 138.0, 48.0 ],
					"style" : "",
					"text" : "map a 360 image/video onto a giant sphere centered on the HMD"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 447.291687, 121.375, 85.0, 22.0 ],
					"style" : "",
					"text" : "jit.gl.texture vr"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 472.0, 227.5, 108.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 472.0, 199.0, 68.0, 22.0 ],
					"style" : "",
					"text" : "route head"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 472.0, 168.0, 77.0, 22.0 ],
					"style" : "",
					"text" : "r /vr/tracking"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 447.291687, 261.0, 305.0, 36.0 ],
					"style" : "",
					"text" : "jit.gl.gridshape world @shape sphere @dim 100 100 @scale 80 80 80 @color 1 1 1 1 @rotatexyz 90 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 447.291687, 89.0, 357.0, 22.0 ],
					"style" : "",
					"text" : "jit.movie @drawto vr @output_texture 1 @moviefile comp_bg.jpg"
				}
...
,
					"patching_rect" : [ 339.000031, 326.0, 40.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 24.0, 403.0, 29.5, 22.0 ],
					"style" : "",
					"text" : "t l l"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 24.0, 151.0, 56.166656, 22.0 ],
					"style" : "",
					"text" : "t b b b"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"outlettype" : [ "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 427.833374, 69.0, 24.0, 24.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 427.833374, 100.0, 141.0, 22.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 336.833374, 100.0, 79.0, 22.0 ],
									"style" : "",
									"text" : "driver oculus"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 251.833374, 100.0, 77.0, 22.0 ],
									"style" : "",
									"text" : "driver steam"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 178.000031, 100.0, 60.0, 22.0 ],
									"style" : "",
									"text" : "configure"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 120.000031, 100.0, 52.0, 22.0 ],
									"style" : "",
									"text" : "connect"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 712.25, 149.0, 276.0, 20.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "jit_gl_texture", "", "" ],
									"patching_rect" : [ 682.75, 232.0, 94.0, 22.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 682.75, 180.0, 135.0, 22.0 ],
									"style" : "",
									"text" : "routepass position quat"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 692.0, 100.0, 235.0, 22.0 ],
									"style" : "",
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 187.75, 144.0, 692.25, 144.0 ],
									"source" : [ "obj-3", 3 ]
								}
...
,
					"patching_rect" : [ 260.250031, 326.0, 63.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 181.500015, 326.0, 77.0, 36.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 102.750008, 326.0, 77.0, 36.0 ],
					"style" : "",
					"text" : "jit.gl.camera world"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "bang", "" ],
					"patching_rect" : [ 24.0, 97.0, 307.0, 36.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 24.0, 298.0, 334.000031, 22.0 ],
					"style" : "",
					"text" : "vr"
				}
...
, 			{
				"box" : 				{
					...
					"grad2" : [ 0.485368, 0.706563, 0.767416, 1.0 ],
					"id" : "obj-9",
					"maxclass" : "panel",
					"mode" : 1,
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 15.0, 86.0, 388.0, 393.0 ],
					"proportion" : 0.39,
					"style" : ""
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 44.0, 436.0, 389.166656, 436.0, 389.166656, 284.0, 33.5, 284.0 ],
					"source" : [ "obj-14", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 52.083328, 276.0, 33.5, 276.0 ],
					"source" : [ "obj-21", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 70.666656, 180.0, 166.5, 180.0 ],
					"source" : [ "obj-28", 2 ]
				}
